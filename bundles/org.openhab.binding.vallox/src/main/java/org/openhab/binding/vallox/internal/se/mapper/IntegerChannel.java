...
public class IntegerChannel extends ValloxChannel {
     ...
     */
    public IntegerChannel(int variable, Unit<?> unit) {
        super(variable, unit);
    }
    ...
    public static class Humidity extends IntegerChannel {
         ...
         * @param variable channel as byte
         */
        public Humidity(int variable, Unit<?> unit) {
            super(variable, unit);
        }
        ...
        public State convertToState(byte value) {
            ...
            return new QuantityType<Dimensionless>(((index - 51) / 2.04), Units.PERCENT);
        }
    ...
    public static class DcFan extends IntegerChannel {
         ...
         * @param variable channel as byte
         */
        public DcFan(int variable, Unit<?> unit) {
            super(variable, unit);
        }

        @Override
        public State convertToState(byte value) {
            return new QuantityType<Dimensionless>(Byte.toUnsignedInt(value), Units.PERCENT);
        }
    }
}
